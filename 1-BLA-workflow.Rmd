...
1.	Curves fitted “manually and by eye” (BYE);
2.	The use of crop simulation modelling for benchmarking potential yields;
3.	Empirically based methods: grouping data and use ‘splines’;
4.	Econometrics based on the use of quantile regression analysis (QREG);
